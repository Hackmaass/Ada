  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (refs.renderer) {
        ...
        refs.renderer = null; // Important to avoid strict mode errors
        refs.scene = null;
      }
    };
  }, []);
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            Adaptive Decision Assistant,
          </p>
          <p className="subtitle-line">
            the intelligence layer powering TalentGraph AI.
          </p>
        </div>
      </div>
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string }> = {
            ...
            1: {
              line1: 'Hire the engineer, not the resume.',
              line2: 'Transforming technical work into trusted intelligence.'
            },
            2: {
              line1: 'Continuous learning from technical work,',
              line2: 'building a living Professional Digital Twin.'
            }
          };
